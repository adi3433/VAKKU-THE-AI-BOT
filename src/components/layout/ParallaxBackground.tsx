  ...
  if (!motionEnabled) {
    return (
      <div
        ...
        style={{
          background:
            'linear-gradient(135deg, var(--color-primary-50) 0%, var(--color-neutral-50) 50%, var(--color-accent-50) 100%)',
        }}
      />
    );
  }
  ...
  return (
    <div className="parallax-container fixed inset-0 -z-10 overflow-hidden">
      ...
      >
        ...
        <div className="absolute -right-10 top-2/3 h-56 w-56 rounded-full bg-[var(--color-accent-200)] opacity-15 blur-3xl" />
      </motion.div>
      ...
      >
        ...
        <div className="absolute right-1/3 bottom-32 h-24 w-24 rounded-full border-2 border-[var(--color-accent-300)] opacity-10" />
      </motion.div>
      ...
      >
        ...
        <div className="absolute right-[20%] top-[20%] h-2 w-2 rounded-full bg-[var(--color-accent-500)] opacity-25" />
